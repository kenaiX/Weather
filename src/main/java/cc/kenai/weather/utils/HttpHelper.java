...
class HttpHelper {
     ...
     *
     * @param strUrl  网页URL地址
     * @param handler 用于向发起本次调用的线程发送结果信息
     * @param what    handler中的what标记
     */
     ...
     *
     * @param strUrl   网页URL地址
     * @param strPost  POST 的数据
     * @param isPost   是否 POST，true 则为POST ,false 则为 GET
     * @param encoding 编码方式
     * @param handler  用于向发起本次调用的线程发送结果信息
     * @param what     handler中的what标记
     */
    ...
    public String getHtml(String strUrl, String strPost, boolean isPost,
        ...
        XLog.xLog("weather response", ret);
        return ret;
    }
     ...
     * @param strUrl   网页URL地址
     * @param strPost  POST 的数据
     * @param isPost   是否POST，true则为POST,false则为 GET
     * @param encoding 编码方式
     * @return 返回bytes
     */
